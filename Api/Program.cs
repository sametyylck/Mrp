...
try
{
    ...
    builder.Services.AddScoped<IValidator<ManufacturingOrderA>, ManufacturingOrderInsertOrderValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingOrderUpdate>, ManufacturingOrderUpdateValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingStock>, ManufacturingOrderDoneValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingTaskDone>, ManufacturingOrderTaskDoneValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingDeleteItems>, ManufacturingOrderDeleteItemsValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingOrderItemsIngredientsUpdate>, ManufacturingOrderItemIngredientUpdateValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingOrderItemsIngredientsInsert>, ManufacturingOrderItemIngredientInsertValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingOrderItemsOperationsInsert>, ManufacturingOrderItemOperationInsertValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingOrderItemsOperationsUpdate>, ManufacturingOrderItemOperationUpdateValidations>();
    builder.Services.AddScoped<IValidator<ManufacturingPurchaseOrder>, ManufacturingOrderPurchaseOrderValidations>();
    ...
    builder.Services.AddScoped<IValidator<SalesOrder>, SalesOrderInsertValidations>();
    builder.Services.AddScoped<IValidator<SalesOrderItem>, SalesOrderInsertItemValidations>();
    builder.Services.AddScoped<IValidator<SalesOrderUpdate>, SalesOrderUpdateValidations>();
    builder.Services.AddScoped<IValidator<SalesDelete>, SalesOrderDeleteValidations>();
    ...
    builder.Services.AddScoped<IValidator<SalesOrderUpdateItems>, SalesOrderItemUpdateItemValidations>();
